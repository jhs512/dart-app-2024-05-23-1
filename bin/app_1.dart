...
class Todo {
  ...
  @override
  String toString() {
    return 'Todo{id: $id, content: $_content, createDate: $createDate, modifyDate: $modifyDate}';
  }
}
